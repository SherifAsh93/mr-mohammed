  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1a3a6b] to-[#1e4080] flex flex-col">
      <div className="px-4 pt-14 pb-10 text-center text-white">
        ...
        <p className="text-white/60 text-sm mt-1">أنشئ حسابك وسجّل في الدورات</p>
      </div>

      <div className="flex-1 bg-white rounded-t-3xl px-6 py-8">
        <h2 className="text-xl font-black text-[#1a3a6b] mb-6">إنشاء حساب جديد</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-bold text-gray-600 mb-1.5">تأكيد كلمة المرور *</label>
            <input
              required
              type="password"
              value={form.confirm}
        ...
        <p className="text-center text-gray-500 text-sm mt-6">
          لديك حساب بالفعل؟{" "}
          <Link href="/login" className="text-[#1a3a6b] font-bold hover:underline">
            سجّل الدخول
          </Link>
        </p>
